...
Repeatable processes and workflows that keep things running.

| System | Scope | Status | Details |
|---|---|---|---|
| Time Allocation | Time planning, daily schedule, sprint modalities | Active | [→](time-allocation.md) |
| Product Pipeline | Product lifecycle phases and property status tracking | Active | [→](product-pipeline.md) |
